                        ...
                        <div class="relative ml-3">
                            <div>
                                ...
                                <div class="div">
                                    ...
                                    <a href="/logout" class=" <?= urlIs('/logout') ? 'bg-gray-900 text-white' : 'text-gray-300'?> text-gray-300 hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">Sign Out</a>
                                </div>
                                <?php else : ?>
